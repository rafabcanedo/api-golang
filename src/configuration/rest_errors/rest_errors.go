...
// Some libs needs to param Error
// So, I created this func for use in this libs how param
func (r *RestErrors) Error() string {
	return r.Message
}

func NewRestErrors(message, err string, code int64, causes []Causes) *RestErrors {
	return &RestErrors{
		Message: message,
		Err: err,
		Code: code,
